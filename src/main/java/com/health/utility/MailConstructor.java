...
public class MailConstructor {
    ...
    public SimpleMailMessage approveRole(User usr, Role role, Category cat, Language lan) {
        ...
        if (role.getRoleId() == 8) {
            message = "Your request for " + role.getName() + "role under the language " + lan.getLangName()
                    + " is been approved.";
        } else if (role.getRoleId() == 7) {
            message = "Your request for " + role.getName() + " is been approved.";
        } else {
            message = "Your request for " + role.getName() + "role under the category " + cat.getCatName()
                    + " and language " + lan.getLangName() + " is been approved.";
        }
